...
def route_grievance(complaint_text: str, selected_category: str = None, ward: str = "Ward 4 - Andheri West") -> dict:
    ...
    authority_name, dept_name = authority_map.get(top_dept, ("Municipal Corporation of Greater Mumbai", "General Public Works"))
    ...
    # Ambiguity penalty if top 2 scores are very close
    ambiguous = False
